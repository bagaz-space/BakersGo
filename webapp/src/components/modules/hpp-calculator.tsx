...
export function HppCalculator() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Recipe selector */}
      <SectionCard title="Pilih Resep" description="Pilih resep yang sudah dibuat di Master Resep. Biaya dasar dihitung otomatis dari komposisi bahan.">
        {recipesLoading ? (
      ...
      {selectedRecipe && (
        <>
          {/* Zona Dapur */}
          <SectionCard title="Zona Dapur — Biaya Operasional" description="Biaya operasional yang dikeluarkan untuk memproduksi satu batch. Isi yang relevan saja, sisanya bisa dikosongkan.">
          ...
          {/* Zona Final */}
          <SectionCard title="Zona Final — Biaya Kemasan" description="Biaya kemasan per batch produksi. HPP total mencakup biaya dasar + dapur + kemasan.">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Zona Produksi */}
          <SectionCard title="Zona Produksi — Item Per Produksi" description="Berapa unit yang dihasilkan dari satu batch resep ini? Digunakan untuk menghitung HPP per unit.">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
          ...
          {/* Margin */}
          <SectionCard title="Zona Penjualan — Margin" description="Tentukan margin keuntungan untuk setiap saluran. Harga jual estimasi dihitung otomatis.">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
      ...
      {hppEntries.length > 0 && (
        <div className="space-y-2">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Daftar kalkulasi HPP yang sudah disimpan. Klik ikon edit untuk mengubah atau gunakan nilainya saat mencatat penjualan.</p>
          </div>
